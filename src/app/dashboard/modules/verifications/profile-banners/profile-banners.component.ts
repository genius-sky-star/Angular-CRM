...
@Component({
  selector: 'app-profile-banners',
  templateUrl: './profile-banners.component.html',
  styleUrls: ['./profile-banners.component.scss'],
})
export class ProfileBannersComponent implements OnInit {
